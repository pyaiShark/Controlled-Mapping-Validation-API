...
schema_view = get_schema_view(
   openapi.Info(
      title="Mapping Entities API",
      default_version='v1',
      description="API for managing Vendors, Products, Courses, and Certifications including their mappings.",
      contact=openapi.Contact(email="Goutam@dev.com"),
   ),
   public=True,
